...
* *dispatch*(uint8_t code, Session& session,  beast::asio::mutable_buffer& buffer) -> size_t : dispatch les arguments reçus à la bonne fonction logique. +
...
* *nb_alive*() const -> size_t : Nombre de joueurs en vie.
