...
Afin d'assurer une authentification fiable et une sécurité relative des données le protocole sera WebSocket over SSL (**WSS**). https://tools.ietf.org/html/rfc6455[RFC 6455]
