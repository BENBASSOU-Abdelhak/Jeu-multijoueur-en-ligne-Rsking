...
atk_result Game::attack_test(Session const& player_asking, uint16_t src_square, uint16_t dst_square, uint16_t nb_troops,
...
BOOST_FIXTURE_TEST_CASE(attack_5, CreateMap)
{
	...
	BOOST_TEST((t_game.get_player_by_id(1).is_online() == false && t_game.get_player_by_id(1).get_tag() == "p2"));
