...
Player::Player(std::string tag)
	: m_tag{ tag }, m_is_online{ true }, m_already_transfered{ false }, m_remaining_deploy_troops{ 0 },
	  m_last_attacked_square{ 0 }, m_square_from_last_attack{ 0 }, m_nb_troops{ 0 },
	  m_nb_square{ 0 }, m_nb_area{ 0 }, m_area_points{ 0 }
{
}
